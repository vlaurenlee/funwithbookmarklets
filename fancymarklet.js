...
var host = 'fancy.com', prefix = 'fancy-bookmarklet-tagger-',
    iframe  = {obj:null, id:prefix+'iframe', win: null, url:location.protocol+'//'+host+'/bookmarklet/bookmarklet.html?v=0027'},
	marker  = {obj:null, id:prefix+'marker'}, // image marker
    style   = {url:location.protocol+'//'+host+'/_ui/bookmarklet/tagger/css/bookmarklet.css?v=0007', id:prefix+'css'},
...
function send(data){ iframe.obj.setAttribute('src', iframe.url+'#tagger:'+data);try{iframe.win.postMessage(data,'http://'+host)}catch(e){} };
// image data
